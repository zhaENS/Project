...
rouseParams.beta            = 1.5; % ~~!!for beta~=2 the polymer is a beta polymer!!~~to set al betas to the same value insert one value only
rouseParams.recipeFolder    = fullfile(pwd,'SimpleRouse','Recipes');
rouseParams.recipeFileName  = 'betaPolymerVariableBetaWithLoopsCorrespondingToPeaksTADD';%'simpleRouseSimulateMeanFirstEncounterEndToEnd';
