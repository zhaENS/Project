...
numSteps                    = (0.008)*(rouseParams.b^2)/(6*(d^2)*sin(pi/(2*rouseParams.numBeads))^2); % n times the number of steps until relaxation of the chain 
...
rouseParams.recipeFileName  = 'simpleRouse307BeadsWithConnectedBeadsCorrespondingToPeaks';%'simpleRouseSimulateMeanFirstEncounterEndToEnd';
