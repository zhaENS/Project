...
rouseParams.numRounds       = 11;% number of simulation rounds 
...
rouseParams.connectedBeads  = [1 107; 108 307]; % the beads connected other than the trivial connections. given by bead pairs
