...
rouseParams.numSimulations  = 2000; % number of simulations in each round
...
numSteps                    = (0.08)*(rouseParams.b^2)/(6*(d^2)*sin(pi/(2*rouseParams.numBeads))^2); % n times the number of steps until relaxation of the chain 
...
rouseParams.recipeFileName  = 'simpleRouse_OneLoop32BeadsTestRelationBeteenKAndb';
