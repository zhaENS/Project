...
rouseParams.numSimulations  = 2;% number of simulations in each round
rouseParams.dimension       = 3;
rouseParams.numBeads        = 108;
rouseParams.b               = 0.1;
...
rouseParams.numSteps        = Inf;%round(numSteps);
...
rouseParams.recipeFileName  = 'simpleRouseConditionalEncounter3BeadsIn108BeadChain';
