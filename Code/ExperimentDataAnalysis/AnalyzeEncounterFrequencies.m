...
%             end
        ...
        function [oneSided,twoSided] = GetEncounterProbabilityMatrix(obj,analysisRange,fName)
...
%                 end
            ...
            % truncate according to the bead range, and divide by the
            % resulting sum of each row to get probabilities 
