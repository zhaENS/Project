...
simulatorParams = SimulationFrameworkParams('dt',0.01,'dimension',3,'numSteps',100,'showSimulation',false,'objectInteraction',false);

% Initialize domains
domainForces    = ForceManagerParams('dt',simulatorParams.simulator.dt,'diffusionForce',true,...
                                     'diffusionConst',0.01,'lennardJonesForce',false);
domainParams(1) = DomainHandlerParams('domainShape','open','domainWidth',10,'forceParams',domainForces);
...
chainParams(1) = ChainParams('numBeads',100,'initializeInDomain',1,'forceParams',chainForces,'b',1);
