...
>>>>>>> b37d0c516ba2907ab13e94275d9c8072c7b33b2a
                ...
                elseif strcmpi(dp.domainShape,'twoPlates')
                    ...
                    points(1).z    = dp.domainWidth*ones(size(points(1).x));
                    
                    [points(2).x,points(2).y] = ...
                        meshgrid(-dp.domainHeight:dp.domainHeight,...
                        -dp.domainHeight:dp.domainHeight,50);
                    points(2).z  = -dp.domainWidth*ones(size(points(2).x));
                ...
                % create a mesh
                if strcmpi(dp.domainShape,'twoPlates')
                obj.handles.graphical.domain(dIdx).mesh(1) = mesh(obj.handles.graphical.mainAxes,...
                ...
                obj.handles.graphical.domain(dIdx).mesh(2) = mesh(obj.handles.graphical.mainAxes,...
