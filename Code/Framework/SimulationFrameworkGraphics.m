...
%                 [~, curPos]     = obj.handles.framework.objectManager.GetPosition(1:numObjects);
                curPos       = obj.handles.framework.objectManager.curPos;
...
%                     c = curPos{oIdx};
                    ...
                    member = obj.handles.framework.objectManager.map.object(oIdx).members;
                ...
                color = get(obj.handles.graphical.chain(member(1)).beads,'Color');
