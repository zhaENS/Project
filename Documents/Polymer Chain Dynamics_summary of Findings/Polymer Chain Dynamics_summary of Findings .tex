...
\section{Analysis of random loop model}
In this section we'll formalize the random loop model with one loop. The chain model consists of a linear chain of $N_c$ beads and a ring of size $N_r$ beads. The ring is added at a random position. Without loss of generality we always number the ring bead connected to the chain as bead 1 of the ring. 
