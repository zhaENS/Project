...
In addition, non-adjacent beads can be fixed to form stable loops throughout the simulation. We extend this idea to allow the formation and dissociation of loops, a model termed dynamic loop model.
